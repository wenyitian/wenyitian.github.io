...
$movietype = '{"class":[{"type_id":1,"type_name":"电影"},{"type_id":2,"type_name":"电视剧"},{"type_id":3,"type_name":"综艺"},{"type_id":4,"type_name":"动漫"},{"type_id":14,"type_name":"韩剧"},{"type_id":15,"type_name":"美剧"}]}';
...
$liebiao='http://www.lezhutv.com/type/{typeid}-{pageid}.html';
//每页多少个影片
$num=72;
//=====================苹果CMS通用模板修改以上内容即可=============================
...
//xpath列表
$query="//ul[@class='tbox_m2']/li/a";

//取出影片的图片
$picAttr="//ul[@class='tbox_m2']/li/a/@data-original";
...
//取出影片的标题
$titleAttr="//ul[@class='tbox_m2']/li/a/@title";

//取出影片的链接
$linkAttr="//ul[@class='tbox_m2']/li/a/@href";

//影视更新情况 例如：更新至*集
$query2 = "//ul[@class='tbox_m2']/li/a/span/text()";
...
//=====================苹果CMS通用模板修改以下内容即可=============================
//影片链接 {vodid}=影片ID 
$detail='http://www.lezhutv.com/detail/{vodid}.html';
//=====================苹果CMS通用模板修改以上内容即可=============================
...
//影片名称
$vodtitle="//div[@class='data']/h4/text()[1]";

//影片类型
$vodtype="//p[@class='yac']/text()";

//取出影片图片 猫的详情图片显示在历史记录里（历史记录图片没有的话，就是这个没取对）
$vodimg="//div[contains(@class,'img')]/@data-original";

//取出影片简介
$vodtext="//div[@class='tbox_js']/text()";

//取出影片年份
$vodyear="";

//取出影片主演
$vodactor="//p[@class='act']/text()";

//取出影片导演
$voddirector="//p[@class='dir']/text()";
...
$playname="//div[@class='tbox_t']/h3";

//播放地址 自动往下级尝试查找5次并取链接 如第二次就找到链接，就会从第二个下级中获取
//$playurl="//div[@class='dbox']/following-sibling::div[1]";
$playurl="//div[@class='tbox2 tabs'][1]";
...
//影片搜索 {wd}=搜索文字
//$searchtype=1的网址
$search=$web.'/index.php?m=vod-search&wd={wd}';
//$searchtype=2的网址
...
//xpath列表
$searchquery='//ul[@class="tbox_m"]/li/a';
//json路径
//$searchquery='list';

//xpath规则取出影片的标题
$searchtitleAttr='//ul[@class="tbox_m"]/li/a/@title';
//json取影片标题
//$searchtitleAttr='name';

//xpath规则取出影片的链接
$searchlinkAttr='//ul[@class="tbox_m"]/li/a/@href';
//json取出影片的ID
//$searchlinkAttr='id';

//xpath规则取影视更新情况 例如：更新至*集
$searchquery2 = '//ul[@class="tbox_m"]/li/a/span/text()';
